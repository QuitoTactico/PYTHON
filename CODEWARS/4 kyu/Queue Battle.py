	...
	while len(armies) > 1:
		...
		if len(bullets) != 0:
			for bullet_index, bullet in enumerate(bullets):
				...
				if bullet.dist <= 0 and target_index not in dead_armies and target_index not in dead_heads: 						# the bullet hits
...
print(queue_battle(100,
				   (25,38,55,46,82),
				   (64,90,37,25,58))) 				# (1,(3,2))

print(queue_battle(200,
				   (61,83,37,55,92,35,68,72),
				   (90,81,36,114,67,25,31,84)))  	# (0,(6,7))

print(queue_battle(300,
				   (98,112,121,95,63),
				   (120,94,90,88,30),
				   (116,144,45,200,32))) 			# (0,(2,))

print(queue_battle(400,
				   (186,78,56,67,78,127,78,192),
				   (78,67,208,45,134,212,82,99),
				   (327,160,49,246,109,98,44,57))) 	# (2,(0,2,5))

print(queue_battle(500,
				   (345,168,122,269,151),
				   (56,189,404,129,101),
				   (364,129,209,163,379),
				   (520,224,154,74,420))) 			# (-1,())
